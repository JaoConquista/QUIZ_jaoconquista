...
export class AdjustOnQuestionTable1754362308509 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."question_type_enum" AS ENUM('multiple_choice', 'boolean', 'short_answer')`);
        await queryRunner.query(`ALTER TABLE "question" ADD "type" "public"."question_type_enum" NOT NULL`);
